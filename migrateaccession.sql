...
UPDATE SAMPLE_ASSAY SET SUBMISSION_ACCESSION = 'ArrayExpress' WHERE SUBMISSION_ACCESSION = 'arrayexpress';
UPDATE SAMPLE_GROUPS SET SUBMISSION_ACCESSION = 'ArrayExpress' WHERE SUBMISSION_ACCESSION = 'arrayexpress';
...
UPDATE SAMPLE_ASSAY SET IS_DELETED = 1 WHERE SUBMISSION_ACCESSION = 'GCG-HisSci';
...
--direct submission cleanup
UPDATE SAMPLE_ASSAY SET SUBMISSION_ACCESSION = 'biosamples' WHERE SUBMISSION_ACCESSION = 'GSB-1' AND IS_DELETED = 0;
