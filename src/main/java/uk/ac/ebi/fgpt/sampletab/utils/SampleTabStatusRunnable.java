...
public class SampleTabStatusRunnable implements Runnable {
	...
	public void run() {
    	...
    	//  currently public and should stay public
    	//  currently public and should be private <- the bad state
    	//  currently private and should be public
    	//  currently private and should stay private
    	//  currently not loaded and should be public
    	//  currently not loaded and should be private
    	...
    	//this is not a perfect check - ideally this should be an API query
